...
The active product is the VS Code extension in `intent-loop/` (VibeCheck). Treat this repository as
...
- Run extension commands from `intent-loop/`.
...
- Update `intent-loop/README.md` when commands, settings, compatibility behavior, or workflows change.

...
Use VS Code workspace storage for private session state. Use `.vibecheck/` only for configuration
...
- `.vibecheck/config.yaml` verification configuration;
...
- schema and validation for `.vibecheck/rules.yaml`;

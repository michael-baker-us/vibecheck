...
<script nonce="${nonce}">
  ...
  function render(data) {
    ...
    const alignmentActions=el('div','item-actions'),refreshInstructions=button(instructionRunning?'Scanning repository…':'Generate agent workspace','refresh-agent-instructions',undefined,'primary'); refreshInstructions.disabled=instructionRunning; alignmentActions.append(refreshInstructions,button('Align safe changes now','align-agent-instructions',undefined,'secondary')); alignment.append(alignmentToggle,alignmentActions);
